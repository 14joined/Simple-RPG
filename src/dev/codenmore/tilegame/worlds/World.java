...
public class World {
    ...
    public World(Handler handler, String path) {
        ...
        entityManager.addEntity(new DarkGate(handler, 550, 500));
        entityManager.addEntity(new DarkGate(handler, 1500, 500));
        entityManager.addEntity(new DarkGate(handler, 2000, 500));
        entityManager.addEntity(new Enemy(handler, 1000, 400, 128, 128));
